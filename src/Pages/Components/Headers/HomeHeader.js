...
function HomeHeader() {
    ...
    return (
        <div id='animation'>
            <div id='header'>
                <h1 id='name' data-aos='fade-right' data-aos-duration='500'>Raafi Rahman TEST</h1>
                <h1 id='title' data-aos='fade-left' data-aos-delay='100' data-aos-duration='500'>Musician, Metaphysician, Mathematician</h1>
